...
public class VRVoiceAssistant : MonoBehaviour
{
    ...
    string GetSceneContext()
    {
        ...
        {
            case "MainMenu":
                return "You are a VR assistant for an app called Agarta AI. Currently you are in the main menu, which can be navigated to go to our virtual" +
                    "tours, as well as other sections. Including Explore World, Marketplace, Events and Experiences, Virtual Campus, Play and Games, My Space, " +
                    "AgartaLab (which are the tours), Web Navigator, and Media and Streaming. Respond in clear, simple language. Output will be spoken aloud.";

            case "Main":
                return "You are a VR assistant located in Agarta AI, a virtual tours app and AI platform. You are currently in one " +
                    "of our tours, in a park called Japanese Friendship Garden. Respond in clear, simple language. Output will be spoken aloud.";
